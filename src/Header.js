...
<div className="header">
      ...
      <div className="modalCriarConta">
          <div className="formCriarConta">
            <div onClick={()=>fecharModalCriar()} className="close-modal-criar">X</div>
              <h2 style={{color:'#F78613'}}>Criar Conta</h2>
      ...
      <div className="modalUpload">
          <div className="formUpload">
            <div onClick={()=>fecharModalUpload()} className="close-modal-criar">X</div>
              <h2 style={{color:'#F78613'}}>Fazer Upload</h2>
                <form id="form-upload" onSubmit={(e)=>uploadPost(e)}>
                    <progress id="progress-upload" value={progress}></progress>
                    <input id="titulo-upload" type="text" placeholder="Nome da sua foto..." />
                    <input onChange={(e)=>setFile(e.target.files[0])} type="file" name="file" />
                    <input type="submit" value="Postar no Highlanders!" />
                </form>
          </div>
      </div>
      ...
      <div className="center">
          <div className="header__logo">
              <a href=""><img src="/logo cla.png" /></a>
          </div>
          {
            (props.user)?
            <div className="header__logadoInfo">
              <span style={{color:'white'}}>Olá, <b>{props.user}</b></span>
            ...
            <div className="header__loginForm">
              ...
              <div className="btn__criarConta">
                <a style={{color:'#F78613'}} onClick={(e)=>abrirModalCriarConta(e)} href="#">cadastrar!</a>
              </div>
          </div>
          }
